(() => {
    ...
    (() => {
        ...
        const o = () => window.location.href !== window.parent.location.href,
            n = "starter-templates-iframe-preview-data", r = () => {
                let e = "";
        ...
        const l = (e, t) => {
            ...
            switch (e.value.param) {
                case"siteLogo":
                    ...
                    } else if ("" !== a) for (const [o, n] of Object.entries(t)) {
                    ...
                    break;
                case"colorPalette":
                    const o = e.value.data.colors || [], n = starter_templates_zip_preview.AstColorPaletteVarPrefix,
                ...
                case"siteTypography":
                    ...
                    (e => {
                        ...
                        const a = [];
                        let o = e["body-font-family"] || "", n = parseInt(e["body-font-weight"]) || "";
                        n && (n = `:wght@${n}`), o && (o = l(o), o = o.replace(" ", "+"), a.push(`family=${o}${n}`));
                        let r = e["headings-font-family"] || "", s = parseInt(e["headings-font-weight"]) || "";
        ...
        window.addEventListener("message", (function (e) {
            ...
            var a;
            t && Object.keys(t.data).map((e => i({value: {param: e, data: t.data[e]}})))
        }))
    })()
})();