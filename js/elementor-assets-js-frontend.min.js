    ...
    9220: (e, t, n) => {
        ...
        class _default extends elementorModules.ViewModule {
            ...
            attachDocumentClass(e) {
                const t = e.data(), n = t.elementorId, o = t.elementorType,
        ...
        var o = n(3203), i = o(n(6397)), s = o(n(8704)), r = o(n(4985)), a = o(n(7537)), l = o(n(355)), d = o(n(2804)),
            c = o(n(3384));
            ...
            this.addHandler = function (t, n) {
                ...
                Array.isArray(n) || (n = [n]), n.forEach((n => function (e, n) {
                    ...
                    elementorFrontend.hooks.addAction(`frontend/element_ready/${i}`, (e => {
                        if (isClassHandler(n)) t.addHandler(n, {$element: e, elementName: i}, !0); else {
                            const o = n();
                            if (!o) return;
                ...
                const n = jQuery(t), o = n.attr("data-element_type");
        ...
        var o = n(3203);
        n(59);
        var i = o(n(9220)), s = o(n(5107)), r = o(n(3308)), a = o(n(1604)), l = o(n(1911)), d = o(n(4773)),
            c = o(n(2064)), u = o(n(8628)), h = o(n(8646)), m = o(n(6866)), g = o(n(4375)), p = o(n(6404)),
            f = o(n(6046)), v = o(n(1322)), b = n(6028);
        const _ = n(9469), y = n(9804), w = n(3346);
        ...
        class Frontend extends elementorModules.ViewModule {
            ...
            addListenerOnce(e, t, n, o) {
                if (o || (o = this.elements.$window), this.isEditMode()) if (this.removeListeners(e, t, o), o instanceof jQuery) {
                    const i = t + "." + e;
                    o.on(i, n)
                } else o.on(t, n, e); else o.on(t, n)
            }
            ...
            waypoint(e, t, n) {
                ...
                return e.elementorWaypoint((function () {
                    const e = this.element || this, o = t.apply(e, arguments);
        ...
        class BackgroundSlideshow extends elementorModules.frontend.handlers.SwiperBase {
            ...
            buildSwiperElements() {
                const e = this.getSettings("classes"), t = this.getElementSettings(),
                    ...
                    i = jQuery("<div>", {class: e.swiperWrapper}), s = t.background_slideshow_ken_burns,
        ...
        class BackgroundVideo extends elementorModules.frontend.handlers.Base {
            ...
            calcVideosSize(e) {
                ...
                const n = this.elements.$backgroundVideoContainer.outerWidth(),
                    o = this.elements.$backgroundVideoContainer.outerHeight(), i = t.split(":"), s = i[0] / i[1],
                    r = n / o > s;
            ...
            startVideoLoop(e) {
                ...
                const t = this.getElementSettings(), n = t.background_video_start || 0, o = t.background_video_end;
            ...
            prepareVimeoVideo(e, t) {
                const n = this.getElementSettings(), o = {
                    url: t,
            ...
            prepareYTVideo(e, t) {
                const n = this.elements.$backgroundVideoContainer, o = this.getElementSettings();
        ...
        var o = n(3203);
        Object.defineProperty(t, "__esModule", {value: !0}), t.default = void 0;
        var i = o(n(4058)), s = o(n(9501)), r = [i.default, s.default];
        t.default = r
    }, 7537: (e, t, n) => {
        var o = n(3203);
        Object.defineProperty(t, "__esModule", {value: !0}), t.default = void 0;
        ...
        class GlobalHandler extends elementorModules.frontend.handlers.Base {
            ...
            animate() {
                ...
                const n = this.getElementSettings(), o = n._animation_delay || n.animation_delay || 0;
        ...
        e.exports = elementorModules.ViewModule.extend({
            getDefaultSettings: () => ({
                ...
                if (location.hostname === n.hostname && i && !(n.hash.length < 2)) {
                    ...
                    if (t.length) {
                        var s = t.offset().top, r = elementorFrontend.elements.$wpAdminBar,
        ...
        t.default = class Controls {
            ...
            getResponsiveControlValue(e, t) {
                ...
                let r = o, a = s.indexOf(o), l = "";
                for (; a <= s.length;) {
                    if ("desktop" === r) {
                        l = i;
                        break
                    }
                    const o = `${t}_${r}`, d = this.getControlValue(e, o, n);
                    if (d || 0 === d) {
                        l = d;
                        break
                    }
        ...
        class LightboxManager extends elementorModules.ViewModule {
            ...
            async onLinkClick(e) {
                const t = e.currentTarget, n = jQuery(e.target), o = elementorFrontend.isEditMode(),
        ...
        t.default = class Swiper {
            ...
            adjustConfig(e) {
                ...
                return Object.keys(e.breakpoints).forEach((o => {
                    const i = parseInt(o);
                    let s;
                    if (i === t.mobile.value || i + 1 === t.mobile.value) s = 0; else if (!t.widescreen || i !== t.widescreen.value && i + 1 !== t.widescreen.value) {
        ...
        class Breakpoints extends elementorModules.Module {
            ...
            getDesktopPreviousDeviceKey() {
                let e = "";
                const {activeBreakpoints: t} = this.responsiveConfig, n = Object.keys(t), o = n.length;
            ...
            getDeviceMinBreakpoint(e) {
                ...
                let o;
                if (n[0] === e) o = 320; else if ("widescreen" === e) o = t[e] ? t[e].value : this.responsiveConfig.breakpoints.widescreen; else {
                    const i = n.indexOf(e);
                    o = t[n[i - 1]].value + 1
                }
                return o
        ...
        e.exports = function () {
            ...
            function _removeHook(e, t, o, i) {
                var s, r, a;
                if (n[e][t]) if (o) if (s = n[e][t], i) for (a = s.length; a--;) (r = s[a]).callback === o && r.context === i && s.splice(a, 1); else for (a = s.length; a--;) s[a].callback === o && s.splice(a, 1); else n[e][t] = []
            }

            function _addHook(e, t, o, i, s) {
                var r = {callback: o, priority: i, context: s}, a = n[e][t];
                if (a) {
                    var l = !1;
            ...
            function _runHook(e, t, o) {
                ...
                if (s = r.length, "filters" === e) for (i = 0; i < s; i++) o[0] = r[i].callback.apply(r[i].context, o); else for (i = 0; i < s; i++) r[i].callback.apply(r[i].context, o);
            ...
            return e = {
                removeFilter: function removeFilter(t, n) {
                    ...
                    var n = t.call(arguments), o = n.shift();
        ...
        const matchUserAgent = e => n.indexOf(e) >= 0, n = navigator.userAgent,
            ...
            l = !!window.chrome && matchUserAgent("Chrome") && !(a || o), d = matchUserAgent("Chrome") && !!window.CSS,
        ...
        var o = n(1695), i = n(2086), s = n(563), r = n(5736), a = n(7826).f, l = n(9606), d = n(1855), c = n(5070),
            u = n(1879), h = n(3621), m = n(79), g = n(5283), p = n(3296), f = "DOMException", v = s("Error"), b = s(f),
            _ = function DOMException() {
                d(this, y);
                var e = arguments.length, t = u(e < 1 ? void 0 : arguments[0]),
                    n = u(e < 2 ? void 0 : arguments[1], "Error"), o = new b(t, n), i = v(t);
                return i.name = f, a(o, "stack", r(1, m(i.stack, 1))), c(o, this, _), o
            }, y = _.prototype = b.prototype, w = "stack" in v(f), k = "stack" in new b(1, 2),
            S = b && g && Object.getOwnPropertyDescriptor(i, f), E = !(!S || S.writable && S.configurable),
            M = w && !E && !k;
        o({global: !0, constructor: !0, forced: p || M}, {DOMException: M ? _ : b});
        var C = s(f), A = C.prototype;
        if (A.constructor !== C) for (var D in p || a(A, "constructor", r(1, C)), h) if (l(h, D)) {
            var $ = h[D], R = $.s;
            l(C, R) || a(C, R, r(6, $.c))
        }
    }
