...
astraSmoothScroll = function (e, t) {
    ...
    var a = getComputedStyle(t).content, n = t.dataset.onDevices, a = a.replace(/[^0-9]/g, "");
    ...
    var r = document.querySelectorAll("#masthead .main-header-menu-toggle"), c = document.getElementById("masthead"),
        i = {}, d = "", u = document.body, m = "";
    ...
    function n(e) {
        ...
        if ("off-canvas" === e) {
            var n = document.getElementById("menu-toggle-close"), s = document.querySelector(".ast-mobile-popup-inner");
            if (null == s) return;
    ...
    "" !== (m = null != c ? c.querySelector("#ast-mobile-header") : m) && null !== m && (d = m.dataset.type), document.addEventListener("astMobileHeaderTypeChange", e, !1), popupTriggerClick = function (e) {
        var e = e.currentTarget.trigger_type, t = document.getElementById("ast-mobile-popup"),
    ...
    for (var t, a, o, l, h = function () {
        var e = u.style.overflow, t = (u.style.overflow = "hidden", document.documentElement.clientWidth);
    ...
    if (document.querySelectorAll(".search-field").forEach(e => {
        ...
        if (E) for (const link of E) link.href.split("#")[0] !== location.href.split("#")[0] ? t.push({
            hash: link.hash,
        ...
        window.addEventListener("DOMContentLoaded", e => {
            for (var a of t) if (window.location.href.split("#")[0] === a.url) {
